  ...
  <div>
    ...
    <section class="slide1">
      <div class="wrap-slick1">
        <div class="slick1">
          <div class="item-slick1 item1-slick1" style="background-image: url(images/master-slide-2.jpg);">
          ...
          <div class="item-slick1 item2-slick1" style="background-image: url(images/master-slide-3.jpg);">
            <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
          ...
          <div class="item-slick1 item3-slick1" style="background-image: url(images/master-slide-1.jpg);">
            <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
...
<script>
  //require('../../vendor/jquery/jquery-3.2.1.js');
  window.$ = window.jQuery = require('jquery');
  require('../../vendor/animsition/js/animsition.js');
  ...
  //require('../template/slick-custom.js');
  require('../../vendor/countdowntime/countdowntime.js');
  require('../../vendor/lightbox2/js/lightbox.js');
